            ...
            <div className="col-span-12 space-y-2.5">
              <div className="lg:mr-16">
                ...
                <p className="text-gray-lite dark:text-gray-400 leading-7">
                  ...
                  servicios turísticos llamado "Náutica SerCyn" conociendo y
                  resolviendo los desafíos que presenta entre desarrollar y
                  llevar a producción una Web (www.sercyn.com). Hasta hace poco
                  que encontré la oportunidad de entrar a Henry y cursar la
                  carrera de Full Stack Developer.
                </p>
                <br />
                <p className="text-gray-lite dark:text-gray-400 leading-7">
