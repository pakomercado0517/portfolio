...
export default function useAllData() {
  ...
  const frameworksData = [
    ...
    },
    {
      id: 5,
      title: "Sequelize",
      icon: <SiSequelize className="w-28 h-28" />,
    ...
    },
    {
      id: 5,
      title: "PostgreSQL",
      icon: <SiPostgresql className="w-28 h-28" />,
    ...
    },
    {
      id: 6,
      title: "Tailwind CSS",
      icon: <SiTailwindcss className="w-28 h-28" />,
    ...
    },
    {
      id: 7,
      title: "HTML",
      icon: <AiFillHtml5 className="w-28 h-28" />,
    ...
    },
    {
      id: 8,
      title: "CSS",
      icon: <BiLogoCss3 className="w-28 h-28" />,
    ...
    },
    {
      id: 9,
      title: "Javascript",
      icon: <BiLogoJavascript className="w-28 h-28" />,
