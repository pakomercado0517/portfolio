  ...
  return (
    ...
    <div className="flex flex-col w-11/12 h-auto lg:flex-row py-10 mx-auto mt-5 bg-blue-50 text-gray-600">
      <div className="w-full lg:w-1/2 lg:my-auto mx-auto justify-center">
        ...
        <img className='w-44 h-44 lg:w-72 lg:h-72 rounded-full mx-auto' src="https://avatars.githubusercontent.com/u/22185306?v=4" alt="Profile_photo" />
      </div>
      <div className="lg:w-1/2 text-justify justify-center">
        <br />
        <h1 className="text-center text-2xl py-1 px-3 mt-4">Acerca de mi.</h1>
        <p className="mt-4 px-5 lg:mr-10 lg:w-full">Alrededor del año 2016, inicié por mi cuenta, como autodidacta, a conocer el mundo de la programación web. Al igual, me llamaron la atención las bases de los lenguajes como C, C++ y obviamente Javascript. <br/>
...
Yo realmente soy consiente que en la red, hay miles de perfiles que sorprenden con la preparación que pueden llegar a tener, pero en mi, sin duda, van a encontrar a una persona motivada, con ganas de sobra de seguir avanzando, aprendiendo, enseñando, resolviendo problemas y sobre todo, el gusto de trabajar en equipo para cumplir metas.</p>
    ...
    <div className="w-11/12 my-5 mx-auto flex justify-center">
      <button className="w-36 h-10 flex flex-row justify-center items-center bg-blue-500 mx-3 text-white rounded-lg shadow-xl cursor-pointer">
        <img src="https://img.icons8.com/material-outlined/24/ffffff/whatsapp--v3.png"/>
        <a className="ml-3" href="https://api.whatsapp.com/send?phone=+527831046697">Contáctame</a>
      </button>
