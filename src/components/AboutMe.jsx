...
function AboutMe() {
  return (
    <div className="flex flex-col w-11/12 h-auto py-10 mx-auto bg-slate-100">
      <div className="text-justify justify-center">
          ...
          <br />
          <hr/>
          <h1 className="text-center text-2xl py-1 px-3">Acerca de mi.</h1>
          <p>Alrededor de hace 5 años, inicié por mi cuenta, como autodidacta, a conocer el mundo de la programación web. Al igual, me llamaron la atención las bases de los lenguajes como C, C++ y obviamente Javascript. <br/>
...
Yo realmente soy consiente que en la red, hay miles de perfiles que sorprenden con la preparación que pueden llegar a tener, pero en mi, sin duda, van a encontrar a una persona motivada, con ganas de sobra de seguir avanzando, aprendiendo, enseñando, resolviendo problemas y sobre todo, el gusto de trabajar en equipo para cumplir metas.</p>
        ...
        <div className="my-5 mx-auto">
          ...
          <button className="w-36 h-10 border-2 border-blue-500 mx-3 text-blue-500 rounded-lg shadow-xl">Descarga mi CV</button>
        </div>
    </div>
  );
}
